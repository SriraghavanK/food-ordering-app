...
const FAQ = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Delivery times vary depending on the restaurant's preparation time, distance, and current demand. You can see the estimated delivery time for each restaurant when browsing. Once you place an order, you'll get a more accurate estimated delivery time."
    },
    {
      question: "Can I schedule an order in advance?",
      answer: "Yes! You can schedule orders up to 7 days in advance. Just select the 'Schedule' option during checkout and choose your preferred date and time."
    },
    {
      question: "What if there's an issue with my order?",
      answer: "If you encounter any issues with your order, please contact our customer support team through the app or website. We're here to help and will work to resolve any problems as quickly as possible."
    },
    {
      question: "How do I become a delivery partner?",
      answer: "To become a delivery partner, visit our 'Become a Driver' page and fill out the application form. You'll need to meet certain requirements, including age, vehicle, and background check criteria."
    },
    {
      question: "Do you offer vegetarian or vegan options?",
      answer: "Yes! Many restaurants on our platform offer vegetarian and vegan options. You can use filters when browsing to show only vegetarian or vegan-friendly restaurants and menu items."
    },
    {
      question: "How do I contact customer support?",
      answer: "You can contact our customer support team through the app or website by going to the 'Help' section. We also offer 24/7 chat support for immediate assistance."
    }
  ];
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {filteredFAQs.length === 0 && (
          <p className="text-center text-gray-600 mt-8">
            No FAQs found matching your search. Please try a different term or browse our full list of questions.
          </p>
        )}
