  ...
  const sections = [
    {
      ...
      content:
        'By accessing or using the SRV FOODS platform, including our website, mobile application, and services (collectively, the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Service.',
    ...
    },
    {
      ...
      content:
        "You agree to use the Service only for lawful purposes and in accordance with these Terms. You are prohibited from using the Service in any way that could damage, disable, overburden, or impair our servers or networks, or interfere with any other partys use and enjoyment of the Service.",
      icon: <Check className="text-orange-500" size={24} />,
    },
    {
      title: "6. Intellectual Property",
      content:
        "The Service and its original content, features, and functionality are owned by SRV FOODS and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.",
    ...
    },
    {
      ...
      content:
        "In no event shall SRV FOODS, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.",
      icon: <Scale className="text-orange-500" size={24} />,
    },
    {
      title: "9. Governing Law",
      content:
        "These Terms shall be governed and construed in accordance with the laws of [TamilNadu/Chennai], without regard to its conflict of law provisions.",
      icon: <Globe className="text-orange-500" size={24} />,
    },
    {
      title: "10. Contact Us",
      content:
        "If you have any questions about these Terms, please contact us at legal@SRVFOODS.com.",
    ...
    <div className="min-h-screen bg-white -mt-8 -ms-8 -me-8 -mb-8">
      <header className="bg-[#e9ebec] text-black py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl">
            Please read these terms carefully before using SRV FOODS
          </p>
        </div>
      </header>
