  ...
  return (
    <div className="min-h-screen bg-white -mt-8 -ms-8 -me-8 -mb-8">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-gray-800">Benefits of Partnership</h2>
        ...
        <section className="mb-12">
          ...
          <ol className="list-decimal list-inside space-y-4 text-gray-600">
            ...
            <li>Receive orders through our easy-to-use tablet or integrate with your POS system</li>
        ...
        <section className="mb-12">
          ...
          <form className="max-w-lg">
            <div className="mb-4">
              <label htmlFor="restaurant-name" className="block text-gray-700 font-bold mb-2">Restaurant Name</label>
              <input type="text" id="restaurant-name" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            <div className="mb-4">
              <label htmlFor="contact-name" className="block text-gray-700 font-bold mb-2">Contact Name</label>
              <input type="text" id="contact-name" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input type="tel" id="phone" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            <button type="submit" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded transition-colors">
              Submit Application
            </button>
          </form>
        </section>
