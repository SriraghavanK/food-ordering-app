          ...
          <div>
            <div className="bg-white p-8 rounded-md shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <ContactInfo icon={<Mail className="text-orange-500" size={24} />} title="Email" content="support@foodieexpress.com" />
                <ContactInfo icon={<MapPin className="text-orange-500" size={24} />} title="Address" content="123 Delivery St, Foodville, FK 12345" />
