...
export default function OrderTracking() {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'Out for Delivery': return <Truck className="text-purple-500" />;
      case 'Delivered': return <CheckSquare className="text-green-500" />;
    ...
    >
      ...
      {filteredOrders.length === 0 ? (
        ...
        >
          ...
          <p className="text-xl text-orange-600">You haven't placed any orders yet.</p>
        </motion.div>
      ) : (
        <motion.div 
          className="space-y-6"
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-semibold text-orange-700">Order #{order._id}</h3>
                  <motion.div
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-orange-800">{new Date(order.createdAt).toLocaleString()}</p>
                  </div>
                  <div className="flex items-center">
